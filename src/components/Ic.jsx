...
export const Ic = ({ n, size = 20, color = "currentColor" }) => {
  const d = {
    ...
    save: <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 10V8a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v2" /><circle cx="15" cy="6" r="2.5" /><circle cx="10" cy="5.5" r="3" /><rect x="2" y="10" width="20" height="11" rx="2" /><circle cx="18" cy="15" r="1.5" fill="currentColor" /></svg>,
    ...
    sparkle: <svg width={size} height={size} viewBox="0 0 24 24" fill={color} stroke="none"><path d="M12 2l2.4 7.4H22l-6.2 4.5 2.4 7.4L12 17l-6.2 4.3 2.4-7.4L2 9.4h7.6z" /></svg>,
    ...
    import: <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" /><polyline points="7 10 12 15 17 10" /><line x1="12" y1="15" x2="12" y2="3" /></svg>,
...
export const LogoIcon = ({ size = 28, style }) => (
  <svg width={size} height={size} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ borderRadius: "22%", display: "inline-block", verticalAlign: "middle", ...style }}>
    <rect width="100" height="100" rx="22" fill="#00C896" />
    <rect x="22" y="68" width="8" height="14" rx="4" fill="white" fillOpacity="0.35" />
    <rect x="35" y="54" width="8" height="28" rx="4" fill="white" fillOpacity="0.35" />
    <rect x="48" y="41" width="8" height="41" rx="4" fill="white" fillOpacity="0.35" />
    <rect x="61" y="28" width="8" height="54" rx="4" fill="white" fillOpacity="0.35" />
    <rect x="74" y="15" width="8" height="67" rx="4" fill="white" fillOpacity="0.35" />
    <polyline points="26,68 39,54 52,41 65,28 78,15" stroke="white" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" />
    <circle cx="26" cy="68" r="4" fill="white" />
    <circle cx="39" cy="54" r="4" fill="white" />
    <circle cx="52" cy="41" r="4" fill="white" />
    <circle cx="65" cy="28" r="4" fill="white" />
    <circle cx="78" cy="15" r="10" fill="white" fillOpacity="0.25" />
    <circle cx="78" cy="15" r="5" fill="white" />
  </svg>
);
